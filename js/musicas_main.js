$(document).ready(function(){//Inicio da função//
    ...
    api("Beautiful+Day","#f6","U2","#f6_inner","#f6_inner_p")
...
function api (nome,image,banda,h3,p){//Inicio da função//
