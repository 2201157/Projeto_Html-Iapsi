...
function alb (){
    ...
    $.ajax({
        method: "GET",
        url: "http://ws.audioscrobbler.com/2.0/?method=album.search&album=Slow+Down+Maverick+Sabre&api_key=cb5873017d844ca90043a3eae82f9055&format=json"
    }).done(function(album){
...
function art(){
     ...
     $.ajax({
        method: "GET",
        url: "http://ws.audioscrobbler.com/2.0/?method=track.search&track=Slowdown+Maverick+Sabre&api_key=cb5873017d844ca90043a3eae82f9055&limit=5&format=json"
